	...
	?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Technology Platform Category</h1>
            <a href="edit_technology_category.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-check fa-sm text-white-50"></i> Add Category</a>
          </div>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                      ...
                      <tbody>
					  <?php
					  $project_features_sql = mysqli_query($connection,"select * from  sumc_technology_category order by id desc ");
						  ...
						  while($project_features_result = mysqli_fetch_array($project_features_sql)) {
							  ...
							  <?php if($project_features_result['status']=='0'){ ?>
										...
										<?php } ?>
                                                          ...
                                                          <td><a href="edit_technology_category.php?id=<?php echo $id; ?>" class="btn-sm btn-primary">Edit</a>&nbsp;
...
$("[id^='delete_']").click(function(){
     	var i=$(this).attr('id');		
   	 	var arr=i.split("_");
   	 	var i=arr[1];
   	 	var r=confirm("Are you sure you want to delete the Technology Category?");
   	 	if(r==true)
   	 	{	
   	 	 $.ajax({
			      	type:"POST",
			      	data:"id="+i,
			      	url:"deletecollection.php?type=sumc_technology_category",
...
$("[id^='status_']").click(function(){
		...
		var j=arr2[1];
   	 	...
   	 	{   	 		
   	 	 $.ajax({
			      	type:"POST",
			      	data:"id="+i+"&"+j+"&tab=sumc_technology_category",
