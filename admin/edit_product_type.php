...
{		
	...
	if($id == 0) {
		$login_query = mysqli_query($connection,"insert into sumc_products_type (title,status,created_date) values ('$title',1,NOW())");
	}
	else {	
		$login_query = mysqli_query($connection,"UPDATE sumc_products_type SET  title='$title' WHERE id ='$id'");		
	}
	if($login_query == 1){
		header("location:product_typelist.php?msg=success");		
	} else {		
		header("location:product_typelist.php?msg=fail");		
	}	
}
...
if($id != 0) {
$features_sql = mysqli_query($connection,"select * from sumc_products_type where id=".$id);
					...
					<div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <a href="product_typelist.php" class="btn btn-primary">Cancel</a>
