...
{		
 ...
 $txt_end_date      =  date("Y-m-d",strtotime($_POST['end_date'])); 	
	...
	if($id == 0) {
		$login_query = mysqli_query($connection,"insert into sumc_projects (title,start_date,end_date,image,description,executive_summary,status,created_date) values ('$title','$txt_start_date','$txt_end_date','','$description','$executive_summary',1,NOW())");
	...
	*/
		...
		$login_query = mysqli_query($connection,"UPDATE sumc_projects SET title='$title',description='$description',executive_summary='$executive_summary',start_date='$txt_start_date',end_date='$txt_end_date' WHERE id ='$id'");	
