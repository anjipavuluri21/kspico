...
{		
	$text1 	=  mysqli_real_escape_string($connection,$_POST['text1']);
        ...
        {	
			...
			$increment2 = '';
				...
				while (file_exists("../uploads/mazzan/" . $name2 . $increment2 . '.' . $extension2)) {
					$increment2++;
				}
				
				$basename2 = $name2 . $increment2 . '.' . $extension2;

				$blocation2 = "uploads/mazzan/" . $basename2;

				$target_file2 = "../uploads/mazzan/" . $basename2;
        ...
        if($image != "") {
					$image = "image = '$image'";
					$updatesql = mysqli_query($connection,"update sumc_mezzan_text set text1='$text1', $image  where id=".$id);
				}
                                else{
                                             $login_query = mysqli_query($connection,"UPDATE sumc_mezzan_text SET  text1='$text1' $image WHERE id ='$id'");		
	...
	if($login_query == 1){
		header("location:edit_mezzantext.php?msg=success");		
	} else {		
		header("location:edit_mezzantext.php?msg=fail");		
	}
}
...
if($id != 0) {
$features_sql = mysqli_query($connection,"select * from sumc_mezzan_text where id=".$id);
	...
	?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
               <h1 class="h3 mb-0 text-gray-800">Mazzan Text</h1>
              </div>
          <div class="row">
            <div class="col-lg-12 mb-12">
              <div class="card shadow mb-8">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Edit Mazzan Text</h6>                    
                    </div>
                <div class="card-body">
