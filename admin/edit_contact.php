...
{			
			...
			$feedback_receiver_email = mysqli_real_escape_string($connection,$_POST['feedback_receiver_email']);	
			
		if($id != 0) {
			$query2 = mysqli_query($connection,"UPDATE sumc_contact_us SET company_name='$company_name',address = '$address',mobile_no='$mobile_no',working_hrs='$working_hrs',lats='$lats',email='$email',longs='$longs',feedback_receiver_email='$feedback_receiver_email' WHERE id= ".$id);			
		}
		else {		
		$query2 = mysqli_query($connection,"INSERT sumc_contact_us (company_name,address,mobile_no,working_hrs,fax_no,email,feedback_receiver_email,lats,longs,status,created_date) values ('$company_name','$address','$mobile_no','$working_hrs','$fax_no','$email','$feedback_receiver_email','$lats','$longs',NOW())");			
		}		
              ...
              <div class="card shadow mb-8">
                ...
                <div class="card-body">
					...
					if($id != 0) {
						...
						$feedback_receiver_email = $contact_list['feedback_receiver_email'];
					}
					...
					?>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <textarea class="form-control" name="working_hrs" id="working_hrs" required="required" rows="4" style="width:600px"><?php echo $working_hrs; ?></textarea>
							...
							<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Feedback Email</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="feedback_receiver_email" id="feedback_receiver_email" class="form-control" value="<?php echo $feedback_receiver_email; ?>"/>
							</div>
						</div>
