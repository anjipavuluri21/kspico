...
{		
	...
	if($id == 0) {
		$login_query = mysqli_query($connection,"insert into sumc_mezzan (title,image,status,created_date) values ('$title','$image',1,NOW())");
	}
	else {	
		if($image != "") {
		...
		$login_query = mysqli_query($connection,"UPDATE sumc_mezzan SET  title='$title' $corse_img  WHERE id ='$id'");		
	}
	if($login_query == 1){
		header("location:mezzanlist.php?msg=success");		
	} else {		
		header("location:mezzanlist.php?msg=fail");		
	}	
}
...
if($id != 0) {
$features_sql = mysqli_query($connection,"select * from sumc_mezzan where id=".$id);
	...
	?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
               <h1 class="h3 mb-0 text-gray-800">MEZZAN HOLDING</h1>
              </div>
          <div class="row">
            <div class="col-lg-12 mb-12">
              <div class="card shadow mb-8">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Edit Mezzan</h6>                    
                    </div>
                <div class="card-body">
