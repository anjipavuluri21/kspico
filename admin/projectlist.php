	...
	?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
			...
			<a href="edit_project.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-check fa-sm text-white-50"></i> Add Project</a>
          </div>
            ...
            <div class="col-lg-12 mb-12">
              ...
              <div class="card shadow mb-8">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">View Projects</h6>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                      ...
                      <tbody>
					  <?php
					  $project_features_sql = mysqli_query($connection,"select * from  sumc_projects order by id desc ");
					  if(mysqli_num_rows($project_features_sql) > 0) {
						  ...
						  while($project_features_result = mysqli_fetch_array($project_features_sql)) {
							  ...
							  <td><a href="edit_project.php?id=<?php echo $id; ?>" class="btn-sm btn-primary">Edit</a>&nbsp;
     	...
     	var i=$(this).attr('id');		
   	 	...
   	 	{	
   	 	 $.ajax({
			      	type:"POST",
			      	data:"id="+i,
			      	url:"deletecollection.php?type=sumc_projects",
