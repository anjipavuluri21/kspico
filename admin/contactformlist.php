                ...
                <div class="card-body">
				  ...
				  <form name="submenuform" method="post" action="banner_ordering.php">
					 <table id="datatable" class="table table-striped jambo_table bulk_action" >
						...
						<?php
						$i = 1;
						$banner_que = mysqli_query($connection,"SELECT * from sumc_contact_feedback ORDER By id DESC");
						...
						?>
                          <tr class="even pointer">                            
							...
							<td class=" "><?php echo $banner_result['contact_name']; ?></td>      
							<td class=" "><?php echo $banner_result['email_id']; ?></td>   	
                            <td class=" "><?php echo $banner_result['created_date'] ?></td>
                            <td style="text-align:center" class=" last"><a class="btn btn-warning" href="view_contactusfeedback.php?id=<?php echo $banner_result[id] ?>">View</a>&nbsp;<a class="btn btn-danger" href="#" id="delete_<?php echo $banner_result[id] ?>">Delete</a>
                            </td>
                          </tr>
                        <?php 
						$i++;
...
$(function(){
	$("[id^='delete_']").click(function(){
     	var i=$(this).attr('id');		
   	 	var arr=i.split("_");
   	 	var i=arr[1];
   	 	var r=confirm("Are you sure you want to delete the Feedback?");
   	 	if(r==true)
   	 	{	
   	 	 $.ajax({
			      	type:"POST",
			      	data:"id="+i,
			      	url:"deletecollection.php?type=sumc_contact_feedback",
			      	success:function(data)
			      	{
			      		if(data=="done")
			      		{
			      			alert("Contact Feedback Deleted Successfully");
			      			location.reload();
			      		}
			      	}
			      });
