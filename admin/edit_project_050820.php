...
{		
	...
	if($id == 0) {
		...
		$login_query = mysqli_query($connection,"UPDATE sumc_projects SET  title='$title',description='$description',start_date='$txt_start_date',end_date='$txt_end_date' $corse_img  WHERE id ='$id'");	
						...
						<table class="table table-bordered" id="item_table">
						  ...
						  if(mysqli_num_rows($area_sql) > 0) {
							   ...
							   <table class="table table-bordered">
								  ...
								  <tr><th>Phase Images</th><td><input type="file" name="phase_images[]" multiple class="form-control text" required /></td></tr>
