...
{		
	...
	if($_FILES['image']['name'] != "")
			...
			$increment_icon = '';
				...
				while (file_exists("../uploads/coroporate/" . $name_icon . $increment_icon . '.' . $extension_icon)) {
					$increment_icon++;
				}
				
				$basename_icon = $name_icon . $increment_icon . '.' . $extension_icon;

				$blocation_icon = "uploads/coroporate/" . $basename_icon;

				$target_file_icon = "../uploads/coroporate/" . $basename_icon;
	...
	if($id == 0) {
		$login_query = mysqli_query($connection,"insert into sumc_coroporate (title,image,status,created_date) values ('$title','$image',1,NOW())");
	}
	else {	
		if($image != "") {
		...
		$login_query = mysqli_query($connection,"UPDATE sumc_coroporate SET  title='$title' $corse_img  WHERE id ='$id'");		
	}
	if($login_query == 1){
		header("location:corporatelist.php?msg=success");		
	} else {		
		header("location:corporatelist.php?msg=fail");		
	}	
}
...
if($id != 0) {
$features_sql = mysqli_query($connection,"select * from sumc_coroporate where id=".$id);
$partners_result = mysqli_fetch_array($features_sql);

$title = $partners_result['title'];
$date	 = $partners_result['date'];
	...
	?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
               <h1 class="h3 mb-0 text-gray-800">Corporate History </h1>
              </div>
          <div class="row">
            <div class="col-lg-12 mb-12">
              <div class="card shadow mb-8">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Edit Corporate History</h6>                    
                    </div>
                <div class="card-body">
					...
					<div class="form-group">
						...
						<div class="col-md-4 col-sm-4 col-xs-6">
							<input type="date" name="date" id="partner_name" class="form-control" required="required" value= "<?php echo $date; ?>">
						</div>
                    </div>                      
                      ...
                      <div class="form-group">
						...
						<a href="corporatelist.php" class="btn btn-primary">Cancel</a>
