...
{			
		...
		if($_FILES['partners_banner']['name'] != "")
		{			
			...
			$increment2 = '';
				...
				$name2 = "partner";
				$extension2 = pathinfo($_FILES['partners_banner']['name'], PATHINFO_EXTENSION);
				...
				if (move_uploaded_file($_FILES['partners_banner']['tmp_name'], $target_file2)) {					
					$partners_banner = $blocation2;										
				}
		}
		...
		{			
			...
			if($id != 0) {
				if($partners_banner != "") {
					$hea_banner = "partners_banner= '$partners_banner'";
				}
				else {
					$hea_banner = "";
				}
				if($side_banner != "") {
					$aw_banner = "partnerside_banner= '$side_banner'";
				}
				else {
					$aw_banner = "";
				}
				...
				$updatesql = mysqli_query($connection,"insert into sumc_banners (partners_banner,partnerside_banner) values ('$partners_banner','$side_banner')");
			}
			if($updatesql) {
				header("location:edit_partnerbanner.php?msg=success");
				exit;
			}
}
$partners_banner="";
...
$partnerside_banner = $booth_features_result['partnerside_banner'];
$partners_banner = $booth_features_result['partners_banner'];
	...
	?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Partner Banners</h1>
          </div>
          <div class="row">
            <div class="col-lg-12 mb-12">
              <div class="card shadow mb-8">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">View Partner Banners</h6>
                </div>
                <div class="card-body">
				<form action="" method="post" name="adv_form" id="adv_form" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                    <div class="form-group">
							...
							<?php
							if(isset($partnerside_banner) && $partnerside_banner != "") {
								?>
								<img src='../<?php echo $partnerside_banner; ?>' height='150px' width='150px;' />
								<?php
							}
							?>
							</div>
				  ...
				  <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Partner Image</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="file" name="partners_banner" id="partners_banner" class="form-control" />
							<p id="note">Please upload image with size 2000X500</p>
							<?php
							if(isset($partners_banner) && $partners_banner != "") {
								?>
								<img src='../<?php echo $partners_banner; ?>' height='150px' width='450px;' />
								<?php
							}
							?>
							</div>
