...
{		
	...
	if($_FILES['image']['name'] != "")
			...
			$increment_icon = '';
				...
				while (file_exists("../uploads/carousel/" . $name_icon . $increment_icon . '.' . $extension_icon)) {
					$increment_icon++;
				}
				
				$basename_icon = $name_icon . $increment_icon . '.' . $extension_icon;

				$blocation_icon = "uploads/carousel/" . $basename_icon;

				$target_file_icon = "../uploads/carousel/" . $basename_icon;
	...
	if($id == 0) {
		$login_query = mysqli_query($connection,"insert into sumc_carousels (title,image,content,status,created_date) values ('$title','$image','$content',1,NOW())");
	}
	else {	
		if($image != "") {
		...
		$login_query = mysqli_query($connection,"UPDATE sumc_carousels SET  title='$title',content='$content' $corse_img  WHERE id ='$id'");		
	}
	if($login_query == 1){
		header("location:carousellist.php?msg=success");		
	} else {		
		header("location:carousellist.php?msg=fail");		
	}	
}
...
if($id != 0) {
$features_sql = mysqli_query($connection,"select * from sumc_carousels where id=".$id);
	...
	?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
               <h1 class="h3 mb-0 text-gray-800">Carousels</h1>
              </div>
          <div class="row">
            <div class="col-lg-12 mb-12">
              <div class="card shadow mb-8">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Edit Carousels</h6>                    
                    </div>
                <div class="card-body">
					...
					<div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <a href="carousellist.php" class="btn btn-primary">Cancel</a>
