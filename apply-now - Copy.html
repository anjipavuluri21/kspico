									...
									<nav class="wsmenu clearfix">
										<ul class="wsmenu-list">
											...
											<li aria-haspopup="true"><a href="javascript:void(0)">PRODUCTS <span class="wsarrow"></span></a>
												<ul class="sub-menu">
													<li aria-haspopup="true"><a href="products-prescriptions.html">Prescriptions</a></li>
	...
	<div class="main-content-area">
		<div class="container">
			...
			<form class="form-signin">
				...
				<div class="form-group">
					<label for="specialty" class="sr-only">Choose your Specialty</label>
				...
				<div class="form-label-group">
					<input type="text" id="specify" class="form-control" placeholder="For other Specialty, please specify">
					<label for="specify">For other Specialty, please specify</label>
				</div>
				
				<div class="form-label-group">
					<input type="text" id="hear-about" class="form-control" placeholder="How did you hear about us?">
